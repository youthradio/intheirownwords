  ...
  <main id="conversation">
    <div class="row">
      <div class="col-12 col-md-8 offset-md-2">
            ...
            <div :class="['card m-1', `${line.cssclass}-border`]">
              <div class="card-body custom-padding">
                <blockquote class="blockquote mb-0">
                  ...
                  <a class="hand-over" v-on:click="tweetMessage(line.name, line.passage)" title="Share on Twitter">
        ...
        <div v-if="!isIframe" v-on:click="scrollTop" class="row justify-content-center align-items-center mt-3 hand-over">
